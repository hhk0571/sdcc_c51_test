...
// Modified based on STC-ISP version by: HHK
...
/* 计时器初值的计算方法:
   T:    定时周期(单位: s)
   FOCS: 晶振频率(单位: HZ)
   计算公式: T/((1/FOSC)*12)=T*FOSC/12

   例如: 定时周期50ms的初值
   11.0592 MHz: 0.05*11059200/12=46080 (注:郭天祥书上是45872)
   12      MHz: 0.05*12000000/12=50000
   22.1184 MHz: 0.05*22118400/12=92160

   例如: 定时周期1ms的初值
   11.0592 MHz: 0.001*11059200/12=922
   12      MHz: 0.001*12000000/12=1000
   22.1184 MHz: 0.001*22118400/12=1843
*/

/* 定时周期为50ms的定时器初值 */
#if FOSC==11059200
#define TIMER_50MS_INIT_VALUE (65536 - 46080) //注:郭天祥书上是45872
#elif FOSC==12000000
#define TIMER_50MS_INIT_VALUE (65536 - 50000)
#elif FOSC==22118400
#define TIMER_50MS_INIT_VALUE (65536 - 92160)
#endif

/* END OF HHK preferences */
